...
export const PlaceholderForCard = () => {
  const placeholderItems: Item[] = [
    ...
    { height: '28px', width: '60%', className: 'ml-6 mb-2 mt-4' },
    { height: '22px', width: '90%', className: 'ml-6' },
    { height: '22px', width: '80%', className: 'ml-6 mt-1' }
  ]
  ...
  const userInfoPlaceholderItems: Item[] = [
    ...
    { height: '16px', width: '40%', className: 'mt-1' }
  ]
